...
The dataset was partitioned into 70\% training, 20\% validation, and 10\% held-out test. The validation set was consulted after every training epoch to select the best model checkpoint. The test set remained untouched throughout training and was used exclusively for the final metrics.
